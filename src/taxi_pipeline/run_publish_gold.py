...
def main():
    ...
    try:
        ...
        print(f"Published gold marts for {result.date_from} through {result.date_to}. Daily Zone Rows: {result.daily_zone_row_count}, Hourly rows: {result.hourly_demand_row_count}")
    finally:
        spark.stop()
